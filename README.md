...
- **[rgss-db-cli](https://github.com/SnowSzn/rgss-db-cli)** — Ruby 实现的 RGSS 数据库导出/导入工具，提供了完整的 RGSS 类型定义和 JSON 转换参考
- **[R3EXS](https://github.com/LuoTat/R3EXS)** — RGSS3 字符串提取/注入工具，提供了**高速 RGSS3A 解密 C 扩展实现**（AVX2/AVX512 向量化，支持 Fux2Pack2 等多种加密格式）
- **[RPGMakerDecrypter](https://github.com/uuksu/RPGMakerDecrypter)** — C# 实现的 RPG Maker 归档文件解密工具，提供了 RGSS1/2 归档解密以及 MV/MZ 媒体文件加解密的参考实现（翻译为 C 原生代码）

## License

Licensed under MIT. See [rm-toolkit.gemspec](rm-toolkit.gemspec).
